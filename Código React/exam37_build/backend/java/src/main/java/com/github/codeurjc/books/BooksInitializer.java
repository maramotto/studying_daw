...
public final class BooksInitializer {

	private BooksInitializer() {
	}

	public static List<Book> getInitialBooks() {
		return List.of(
				createBook("SUEÑOS DE ACERO Y NEON",
				...
				createBook("LA VIDA SECRETA DE LA MENTE",
				...
				createBook("TERMINAMOS Y OTROS POEMAS SIN TERMINAR",
	...
	private static Book createBook(String title, String description) {
		Book book = new Book();
		book.setTitle(title);
